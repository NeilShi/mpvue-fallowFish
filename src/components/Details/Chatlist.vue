...
<div class="container">
  <div class="chatlist" ref="chatlist" :class="showBox==1?'popbox':'listbottom'">
    <ul>
      <div v-for="(item,index_item) in talks" :key="index_item">
        ...
        <div class="emojis">
          <div class="swiper-container" ref="swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="(n,index_n) in Math.ceil(EXPS.length/18)" :key="index_n">
                <li v-for="(item, index_li) in getEXP(n,18)" :key="index_li">
