<template>
  <div class="container">
    ...
    <div class="infobox" v-if="show" v-for="(item,index_item) in fabuinfo" :key="index_item">
      <div class="username">
        <img :src="url" alt="">
      ...
      <div class="imgbox">
        <div class="img" v-for="(img, index_img) in item.imgUrls" :key="index_img">
      ...
      <div class="operate">
        <div class="del" v-if="item.del" @click="del(index_item)">删除发布</div>
      </div>
    </div>
