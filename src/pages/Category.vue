  ...
  <div class="container">
    ...
    <div class="category">
      <div class="menu-wrapper" ref="menu">
        <ul>
          <li class="menu-item" :class="{'current':currentIndex===index_category}" v-for="(item,index_category) in category" :key="index_category" ref="menuItem" @click="selectMenu(index_category)">
        ...
        <ul>
          <li class="list-item" v-for="(item,index) in category" :key="index" ref="listItem">
            ...
            <ul class="itemContainer">
              <li class="item" v-for="(list,index_img) in item.imglist" :key="index_img">
                <div class="imgbox">
