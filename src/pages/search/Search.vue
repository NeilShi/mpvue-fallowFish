  ...
  <div class="container">
    <div class="head">
      <div class="back" @click="goBack">
        <a href="/pages/index/main" class="navlink"><img src="../../assets/images/返回.png" alt=""></a>
      </div>
      <div class="searchbox">
        <input type="search" autofocus @keypress="search(keywords)" v-model="keywords" placeholder="小冰箱">
      </div>
      <div class="searchbtn">
