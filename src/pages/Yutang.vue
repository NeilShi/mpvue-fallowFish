  ...
  <div class="container">
    ...
    <div class="interest">
      ...
      <div class="swiper-container" ref="swiper">
        <div class="swiper-wrapper swiper">
          <div class="swiper-slide item" v-for="(item,index_interests) in interests" :key="index_interests" @click="toast">
    ...
    <div class="interest">
      ...
      <div class="swiper-container" ref="tuhao">
        <div class="swiper-wrapper swiper">
          <div class="swiper-slide item" v-for="(item,index_tuhao) in tuhao" :key="index_tuhao" @click="toast">
    ...
    <div class="interest">
      ...
      <div class="swiper-container" ref="china">
        <div class="swiper-wrapper swiper">
          <div class="swiper-slide item" v-for="(item,index_china) in china" :key="index_china" @click="toast">
              <div class="imgdisplay" v-if="item.img !== undefined">
                <img :src="item.img" alt="" class="imgbig">
              </div>
              <div class="name">{{item.title}}</div>
    ...
    <div class="interest bottom2">
      ...
      <div class="list border-1px" v-for="(item,index_lists) in lists" :key="index_lists">
